...
export function Navbar() {
  ...
  const [spotifySigningIn, setSpotifySigningIn] = useState(false);
                ...
                <>
                  {isLanding ? (
                    ...
                    <button
                      onClick={handleSpotifySignIn}
                      disabled={spotifySigningIn}
                      className="inline-flex items-center gap-2 rounded-full bg-[#1DB954] px-4 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-[#1ed760] hover:shadow-[0_0_20px_rgba(29,185,84,0.3)] disabled:opacity-70"
                    ...
                    >
                      ...
                      {spotifySigningIn ? "Redirecting..." : "Connect Spotify"}
                    </button>
                  )}
                </>
              )}
