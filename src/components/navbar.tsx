                ...
                <>
                  {isLanding ? (
                    ...
                    <button
                      onClick={() => signIn("google", { callbackUrl: "/dashboard" })}
                      disabled={spotifySigningIn}
                      className="inline-flex items-center gap-2 rounded-full bg-red-600 px-4 py-2 text-sm font-semibold text-white transition-all duration-300 hover:bg-red-700 hover:shadow-[0_0_20px_rgba(220,38,38,0.3)] disabled:opacity-70"
